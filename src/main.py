...
##############Navigation Menu Actions#########################
        self.actionNext = QtGui.QAction(QtGui.QIcon('../icons/next.ico'),'Next',self)
        self.connect(self.actionNext,QtCore.SIGNAL('triggered()'),self.actionNextActivated)
        
        self.actionStep_Out = QtGui.QAction(QtGui.QIcon('../icons/step_out.ico'),'Step Out',self)        
        self.connect(self.actionNext,QtCore.SIGNAL('triggered()'),self.actionStepOutActivated)
        
        self.actionStep = QtGui.QAction(QtGui.QIcon('../icons/step.ico'),'Step',self)
        self.connect(self.actionStep,QtCore.SIGNAL('triggered()'),self.actionStepActivated)
        
        self.actionStep_into_asm = QtGui.QAction(QtGui.QIcon('../icons/step_into_asm.ico'),'Step into asm',self)
        self.connect(self.actionStep_into_asm,QtCore.SIGNAL('triggered()'),self.actionStep_into_asmTriggered)
        
        self.actionStep_over_asm = QtGui.QAction(QtGui.QIcon('../icons/step_over_asm.ico'),'Step over asm',self)
...
##############Toolbar##########################################
        ...
        self.actiontoolOpen_Executable = QtGui.QAction(QtGui.QIcon('../icons/load-executable.png'),'Open Executable',self)
        self.toolBar.addAction(self.actiontoolOpen_Executable)

        self.toolBar.addSeparator()

        self.run_runprocess = QtGui.QAction(QtGui.QIcon('../icons/run.png'),'Run Process',self)
        self.toolBar.addAction(self.run_runprocess)
        self.run_continue = QtGui.QAction(QtGui.QIcon('../icons/continue.png'),'Continue',self)
        self.toolBar.addAction(self.run_continue)
        self.run_restartprocess = QtGui.QAction(QtGui.QIcon('../icons/restart.png'),'Restart Process',self)
        self.toolBar.addAction(self.run_restartprocess)
        self.run_stopprocess = QtGui.QAction(QtGui.QIcon('../icons/stop.png'),'Stop Process',self)
        ...
        self.breakpoints_create = QtGui.QAction(QtGui.QIcon('../icons/breakpoint-new.png'),'Create Breakpoint',self)
        self.toolBar.addAction(self.breakpoints_create)        
        self.breakpoints_disable = QtGui.QAction(QtGui.QIcon('../icons/breakpoint-disable.png'),'Disable Breakpoint',self)
        self.toolBar.addAction(self.breakpoints_disable)
        self.breakpoints_disableall = QtGui.QAction(QtGui.QIcon('../icons/breakpoint-disableall.png'),'Disable All Breakpoints',self)
        self.toolBar.addAction(self.breakpoints_disableall)
        self.breakpoints_enable = QtGui.QAction(QtGui.QIcon('../icons/breakpoint-enable.png'),'Enable Breakpoint',self)
        self.toolBar.addAction(self.breakpoints_enable)        
        self.breakpoints_removeall = QtGui.QAction(QtGui.QIcon('../icons/breakpoint-removeall.png'),'Remove All Breakpoints',self)
